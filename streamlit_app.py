...
st.info('Reference List of datasets used<br>Singapore Department of Statistics. (2024). Waste Management And Overall Recycling Rates, Annual (2025) [Dataset]. data.gov.sg. Retrieved August 30, 2025 from https://data.gov.sg/datasets/d_daf568968ab40dc81e7b08887a83c8fa/view')
